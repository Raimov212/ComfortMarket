...
export const EnterToInvoiceIcons = () => {
  return (
    <div>
      <svg fill="rgb(2 6 23)" width="28px" height="28px" viewBox="0 0 92 92">
        <path
          d="M89,13v66c0,2.2-1.8,4-4,4H32.9c-2.2,0-3.9-1.8-3.9-4V60.7c0-2.2,1.8-4,4-4s4,1.8,4,4V75h44V17H37v14.3
...
export const ExitFromInvoiceIcons = () => {
  return (
